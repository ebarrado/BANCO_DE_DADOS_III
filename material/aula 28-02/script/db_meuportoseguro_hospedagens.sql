...
CREATE TABLE `hospedagens` (
  ...
  CONSTRAINT `hospedagens_ibfk_1` FOREIGN KEY (`endereco_id`) REFERENCES `enderecos` (`endereco_id`),
  CONSTRAINT `hospedagens_ibfk_2` FOREIGN KEY (`proprietario_id`) REFERENCES `proprietarios` (`proprietario_id`)
...
-- Dump completed on 2025-02-28 20:50:01
